...
const Login = () => {
    ...
    <div className="flex h-screen flex-col md:flex-row">
        ...
        <div className="bg-loginbg bg-cover bg-center w-full md:w-5/6 flex flex-col gap-6 md:gap-10 pr-0 md:pr-5">
            ...
            <form className="flex flex-col gap-4 md:gap-6 bg-[#ffffff41] bg-opacity-0 rounded-xl shadow-lg p-6 md:p-10 max-w-full md:max-w-md mx-auto mt-8 md:mt-20 w-full">
