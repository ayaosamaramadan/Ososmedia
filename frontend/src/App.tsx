...
import FriendsRequestsList from "./components/friendFunc/FriendsRequestsList";
import AllUsers from "./components/friendFunc/AllUsers";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/user/:id"
          element={isAuth ? <OthersProfile /> : <Navigate to="/" replace />}
        />
